...
public class MostDigitsTest {
  ...
  public void secretTest1() {
    assertEquals(1559910225, MostDigits.findLongest(new int[]{1559910225, -1113027678}));
    assertEquals(1559910225, MostDigits.findLongest(new int[]{-1113027678, 1559910225}));
  }
